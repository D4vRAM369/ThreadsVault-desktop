...
- **Reproductor integrado** — reproduce los vídeos de los posts que quedan guardados en tu bóveda personal, además de posibilidad de descarga. Esto ha sido posible gracias a la integración de yt-dlp y ffmpeg, nueva feature de la versión 2.0
